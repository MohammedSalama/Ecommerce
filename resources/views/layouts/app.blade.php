...
<head>
    ...
    <link rel="shortcut icon" type="image/x-icon" href="{{ URL::asset('layouts/assets/imgs/theme/favicon.ico') }}">
    <link rel="stylesheet" href="{{ URL::asset('layouts/assets/css/main.css') }}">
    <link rel="stylesheet" href="{{ URL::asset('layouts/assets/css/custom.css') }}">
    @livewireStyles
</head>
                                ...
                                <div class="cart-dropdown-wrap cart-dropdown-hm2">
                                    <ul>
                                        <li>
                                            <div class="shopping-cart-img">
                                                <a href="product-details.html"><img alt="Surfside Media"
                                                                                    src="{{ URL::asset('layouts/assets/imgs/shop/thumbnail-3.jpg') }}"></a>
                                            </div>
                                        ...
                                        <li>
                                            <div class="shopping-cart-img">
                                                <a href="product-details.html"><img alt="Surfside Media"
                                                                                    src="{{ URL::asset('layouts/assets/imgs/shop/thumbnail-2.jpg') }}"></a>
                                            </div>
                                            <div class="shopping-cart-title">
                            ...
                            <div class="cart-dropdown-wrap cart-dropdown-hm2">
                                <ul>
                                    ...
                                    <li>
                                        <div class="shopping-cart-img">
                                            <a href="product-details.html"><img alt="Surfside Media"
                                                                                src="{{ URL::asset('layouts/assets/imgs/shop/thumbnail-4.jpg') }}"></a>
                                        </div>
                                        <div class="shopping-cart-title">
...
<!-- Vendor JS-->
<script src="{{ URL::asset('layouts/assets/js/vendor/modernizr-3.6.0.min.js') }}"></script>
<script src="{{ URL::asset('layouts/assets/js/vendor/jquery-3.6.0.min.js') }}"></script>
<script src="{{ URL::asset('layouts/assets/js/vendor/jquery-migrate-3.3.0.min.js') }}"></script>
<script src="{{ URL::asset('layouts/assets/js/vendor/bootstrap.bundle.min.js') }}"></script>
<script src="{{ URL::asset('layouts/assets/js/plugins/slick.js') }}"></script>
<script src="{{ URL::asset('layouts/assets/js/plugins/jquery.syotimer.min.js') }}"></script>
<script src="{{ URL::asset('layouts/assets/js/plugins/wow.js') }}"></script>
<script src="{{ URL::asset('layouts/assets/js/plugins/jquery-ui.js') }}"></script>
<script src="{{ URL::asset('layouts/assets/js/plugins/perfect-scrollbar.js') }}"></script>
<script src="{{ URL::asset('layouts/assets/js/plugins/magnific-popup.js') }}"></script>
<script src="{{ URL::asset('layouts/assets/js/plugins/select2.min.js') }}"></script>
<script src="{{ URL::asset('layouts/assets/js/plugins/waypoints.js') }}"></script>
<script src="{{ URL::asset('layouts/assets/js/plugins/counterup.js') }}"></script>
<script src="{{ URL::asset('layouts/assets/js/plugins/jquery.countdown.min.js') }}"></script>
<script src="{{ URL::asset('layouts/assets/js/plugins/images-loaded.js') }}"></script>
<script src="{{ URL::asset('layouts/assets/js/plugins/isotope.js') }}"></script>
<script src="{{ URL::asset('layouts/assets/js/plugins/scrollup.js') }}"></script>
<script src="{{ URL::asset('layouts/assets/js/plugins/jquery.vticker-min.js') }}"></script>
<script src="{{ URL::asset('layouts/assets/js/plugins/jquery.theia.sticky.js') }}"></script>
<script src="{{ URL::asset('layouts/assets/js/plugins/jquery.elevatezoom.js') }}"></script>
<!-- Template  JS -->
